...
email_data = pd.read_csv("E:/Assignments/Assignment week 13/Naive bayes/Assignment/sms_raw_NB.csv",encoding = "ISO-8859-1")
...
email_train, email_test = train_test_split(email_data, test_size = 0.24)
